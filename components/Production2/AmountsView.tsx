    ...
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      ...
      {showFocusPanel && (
        <PlanFocusPanel
          ...
          // Lowstock cards need the live till counts to render the
          // "sold / plan / left" cells and clear the resolved badge once
          // the manager bumps the plan back above threshold. AmountsView
          // already builds this map for the table's Sold column.
          soldByItemId={liveSales?.byItemId}
          date={date}
        />
      )}
