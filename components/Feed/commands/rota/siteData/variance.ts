...
const VARIANCE: Record<string, SiteDayVariance> = {
  'fitzroy-heathrow': {
    ...
    causes: [
      ...
      { kind: 'late-clock-out', gbp: 20, minutes: 80, detail: 'Both closers out at 22:55 against 22:15' },
      { kind: 'early-clock-in', gbp: 7.5, minutes: 30, detail: 'Three openers in at 04:35 for a 04:45 start' },
    ],
  ...
  'fitzroy-gatwick': {
    ...
    causes: [
      ...
      { kind: 'missed-break', gbp: 22.5, minutes: 90, detail: 'Three 8h shifts closed with no break recorded', repeat: 'third Saturday running', compliance: true },
      { kind: 'late-clock-out', gbp: 18.75, minutes: 75, detail: 'Jonah Reid out at 21:55 and Carla Mendes at 21:50 against 21:15' },
    ],
  ...
  'fitzroy-espresso': {
    ...
    forecastGBP: 0,
    causes: [
      { kind: 'late-clock-out', gbp: 10, minutes: 40, detail: 'Bake team out at 14:20 against 14:00, two people' },
      { kind: 'early-clock-in', gbp: 1.25, minutes: 5, detail: 'One clock-in five minutes early' },
    ],
