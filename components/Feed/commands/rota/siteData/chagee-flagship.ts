...
const CHAGEE_HOUR_SHAPE: Record<number, number> = {
  ...
  13: 1180, 14: 1420, 15: 1520, 16: 1360,
  17: 1100, 18: 980, 19: 1240, 20: 1160, 21: 720,
};
...
export function CHAGEE_FLAGSHIP_LABOUR(): SiteLabourData {
  ...
  return {
    ...
    openMin: H(10),
    closeMin: H(22),
    weeklySalesGBP: 78500,
    avgTicketGBP: 5.2,
    // Tea bars trade heavier at the weekend than a commuter café does.
    dayMultiplier: { ...dm, Fri: 1.15, Sat: 1.3, Sun: 1.1 },
    hourShape: CHAGEE_HOUR_SHAPE,
    hourAdjust: {
      Sat: { 14: 1.15, 15: 1.15, 16: 1.15 },
    },
    signals: {
      Sat: [{ label: 'Saturday afternoon', effectPct: 15, detail: 'up on the last four Saturdays: app pre-orders and a 60-cup group order at 14:30' }],
      Fri: [{ label: 'Friday', effectPct: 15, detail: 'end-of-week lift, office group orders' }],
    },
    standards: [
      { productType: 'Fresh milk tea', mix: 0.6, humanSeconds: 42, machineSeconds: 8, provenance: 'CHAGEE line standard: machine dispenses in 8s; finishing, seal, label and hand-over about 42s. Unverified against store timestamps.' },
      { productType: 'Fruit tea with toppings', mix: 0.25, humanSeconds: 58, machineSeconds: 8, provenance: 'CHAGEE line standard plus topping scoop. Unverified.' },
      { productType: 'Pure tea', mix: 0.15, humanSeconds: 30, machineSeconds: 8, provenance: 'CHAGEE line standard, no toppings. Unverified.' },
    ],
    stations: [
      { id: 'machine-1', name: 'Machine 1', demandShare: 0.1, hasMachine: true, machineUnitsPerHour: 450 },
      { id: 'machine-2', name: 'Machine 2', demandShare: 0.1, hasMachine: true, machineUnitsPerHour: 450 },
    ...
    fixedTasks: [
      { id: 'brew-open', label: 'Brew bases', day: 'daily', start: H(10), end: H(11), humanMinutes: 40, machineMinutes: 20, stationId: 'machine-1', source: 'brew', evidence: 'Brew schedule: jasmine green and orchid oolong bases ready for 11:00' },
      { id: 'pearls', label: 'Cook pearls', day: 'daily', start: H(10), end: H(12), humanMinutes: 50, stationId: 'restock', source: 'prep', evidence: 'Topping prep from the brew schedule: tapioca pearls, two batches' },
      { id: 'hoppers', label: 'Hopper refills', day: 'daily', start: H(13), end: H(21), humanMinutes: 120, stationId: 'restock', source: 'prep', evidence: 'Hopper refill every 200 cups, about 15 refills across the afternoon and evening' },
      { id: 'group-sat', label: 'Group order, 60 cups', day: 'Sat', start: H(14), end: H(15), humanMinutes: 45, machineMinutes: 8, stationId: 'finishing', source: 'order', evidence: 'Group order of 60 cups booked for 14:30 Saturday, office nearby' },
      { id: 'close', label: 'Close-down', day: 'daily', start: H(21), end: H(22), humanMinutes: 90, stationId: 'restock', source: 'clean', evidence: 'Close-down checklist: machines flushed, hoppers washed' },
