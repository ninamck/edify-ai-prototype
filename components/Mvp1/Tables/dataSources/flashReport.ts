...
export const FLASH_REPORT_COLUMNS: Column[] = [
  ...
  { key: 'week_number', header: 'Week #', type: 'integer', width: 90 },
  { key: 'week_start_date', header: 'Week start', type: 'date', defaultVisible: true, width: 120 },
  { key: 'week_end_date', header: 'Week end', type: 'date', width: 120 },
