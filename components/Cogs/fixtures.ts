...
// the live product surfaces — negative usages from un-logged transfers,
// duplicate master products, recipe usage with no stock movement, etc.
...
export const COGS_VARIANCE_ROWS: CogsVarianceRow[] = [
  ...
  {
    id: 'arabic-protein-bread-a',
    name: 'Arabic Protein bread',
    productClass: 'Food',
    packType: 'Pack',
    unitCost: 0.85,
    openingStock: 0,
    ...
    varCost: 153.0,
    varPct: 100,
    insightId: 'arabic-protein-bread',
  },
  {
    id: 'arabic-protein-bread-b',
    name: 'Arabic Protein bread',
    productClass: 'Food',
    packType: 'Pack',
    unitCost: 0.85,
